...
(script static boolean trainreinf_1_4
(< g_train02_obj_control 4))
...
(script static boolean trainturre_1_10
(= (ai_living_count Training02_Squad04) 1))

(script static boolean trainsleep_1_14
(or (< (ai_task_status training02_objective/b_attack01) 1) (< g_train02_obj_control 1)))

(script static boolean trainbrute_1_15
...
(script static boolean trainhunte_3_25
(volume_test_players hunter_follow_vol))

(script static boolean traingloba_3_27
