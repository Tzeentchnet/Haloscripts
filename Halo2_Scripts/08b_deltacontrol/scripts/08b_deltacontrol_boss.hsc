...
(script static short boss_tartarus_rateofrecharge
	(cond
		((difficulty_legendary)	(random_range (* 1 seconds) (* 2 seconds)))
		((difficulty_heroic)	(random_range (* 1 seconds) (* 3 seconds)))
		(TRUE				(random_range (* 2 seconds) (* 3 seconds)))
	)
)

(script static short boss_johnson_rateoffire
	(cond
		((difficulty_legendary)	(random_range (* 7 seconds) (* 15 seconds)))
		((difficulty_heroic)	(random_range (* 5 seconds) (* 12 seconds)))
		(TRUE				(random_range (* 4 seconds) (* 10 seconds)))
	)
)

(script static short boss_rateofreenforcement
	(cond
		((difficulty_legendary)	(random_range (* 30 seconds) (* 60 seconds)))
		((difficulty_heroic)	(random_range (* 30 seconds) (* 60 seconds)))
		(TRUE				(random_range (* 30 seconds) (* 60 seconds)))
	)
)
...
(script static void tartarus_boss_fight
	...
	(sleep_until (= (ai_living_count boss_brute_start) 0) 1 (* 15 seconds))
	(ai_place boss_elite_reenforcements)

	(sleep_until (volume_test_objects tv_boss_platform (players)) 1 (* 30 seconds))
	(sleep (* 10 seconds))
		...
		(cond
			...
			((and
				...
				(> (player_count) 0)
																						...
																						(sleep_until (volume_test_objects tv_boss_platform (players)) 1 (* 15 seconds))
																						FALSE
																					))
